...
3. **Compute & Rendering (Google Cloud Run)**: A containerized Python 3.12 / FastAPI backend hosts the API, the Deterministic Workflow Engine, and headless FFmpeg rendering workers.
