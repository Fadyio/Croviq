...
const decisionTitle = (decision: EditorDecision): string => {
  if (decision.decision_type === "FALSE_START" || decision.decision_type === "REMOVE_FALSE_START")
    return "False start removed";
  ...
  if (decision.decision_type === "FILLER" || decision.decision_type === "REMOVE_FILLER")
    return "Filler removed";
  if (
    decision.decision_type === "REDUNDANT_EXPLANATION" ||
    decision.decision_type === "RAMBLING" ||
    decision.decision_type === "REMOVE_LOW_VALUE_SECTION"
  )
    return "Redundant explanation removed";
  if (decision.decision_type === "PACING" || decision.decision_type === "TIGHTEN_EXPLANATION")
    return "Pacing tightened";
  if (decision.decision_type === "SOURCE_COVER") return "Source coverage";
  if (decision.decision_type === "KEEP_FOR_CLARITY" || decision.decision_type === "KEEP")
