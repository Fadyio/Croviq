...
export interface CroviqLogoProps {
  className?: string;
...
export const CroviqLogo: React.FC<CroviqLogoProps> = ({
  ...
  if (variant === "symbol") {
    return (
      ...
      >
        <defs>
          <clipPath id="croviq-symbol-clip">
        ...
        <g clipPath="url(#croviq-symbol-clip)">
  ...
  if (variant === "stacked") {
    return (
      <svg
        ...
        aria-label="Croviq"
      >
        <g transform="translate(250,0) scale(.7)">
          <defs>
            <clipPath id="croviq-stacked-clip-top">
              <polygon points="120,260 500,40 860,250 700,430 560,330 390,260 260,440 290,620 470,710 600,620 840,590 560,850 290,770 100,520" />
            </clipPath>
          </defs>
          <g clipPath="url(#croviq-stacked-clip-top)">
            <polygon points="100,260 500,40 390,260" fill="#FF9F1C" />
            <polygon points="100,260 390,260 260,440" fill="#FFBD16" />
            <polygon points="100,260 260,440 100,520" fill="#FFB514" />
            <polygon points="500,40 620,260 390,260" fill="#FF6B3D" />
        ...
        <g transform="translate(80,830) scale(.26)">
          <defs>
            <clipPath id="croviq-stacked-clip-bot">
              <polygon points="120,260 500,40 860,250 700,430 560,330 390,260 260,440 290,620 470,710 600,620 840,590 560,850 290,770 100,520" />
            </clipPath>
          </defs>
          <g clipPath="url(#croviq-stacked-clip-bot)">
            <polygon points="100,260 500,40 390,260" fill="#FF9F1C" />
            <polygon points="100,260 390,260 260,440" fill="#FFBD16" />
            <polygon points="100,260 260,440 100,520" fill="#FFB514" />
            <polygon points="500,40 620,260 390,260" fill="#FF6B3D" />
