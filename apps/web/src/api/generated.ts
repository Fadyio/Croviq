...
export interface paths {
  ...
  "/api/productions/{production_id}/review-preview": {
      post: {
        responses: {
          200: components['schemas']['ReviewPreviewResponse']; 422: components['schemas']['HTTPValidationError'];
        };
      };
  };
  "/api/productions/{production_id}/render-review": {
      get: {
        responses: {
          200: components['schemas']['RenderReviewDetailResponse']; 422: components['schemas']['HTTPValidationError'];
        };
      };
  };
  ...
  "/api/productions/{production_id}/release-review/correct": {
      post: {
        responses: {
          200: components['schemas']['AutoCorrectQAResponse']; 422: components['schemas']['HTTPValidationError'];
        };
      };
  };
...
export interface components {
  schemas: {
    ...
    EditorDecisionType: "KEEP" | "REMOVE_SILENCE" | "REMOVE_FILLER" | "REMOVE_FALSE_START" | "REMOVE_REPETITION" | "TRIM_PAUSE" | "TIGHTEN_PAUSE" | "TIGHTEN_EXPLANATION" | "REMOVE_LOW_VALUE_SECTION" | "KEEP_FOR_CLARITY" | "BROLL_COVER" | "BROLL_COVER_CANDIDATE" | "SOURCE_COVER" | "CHAPTER_MARKER" | "SHORT_CANDIDATE" | "NARRATION_REWRITE" | "CAPTION_EMPHASIS";
    EditorProposal: {
      /** Associated Production entity identifier */
      production_id: string;
    ...
    RenderReviewIssueType: "UNNATURAL_AUDIO_JOIN" | "VISUAL_JUMP" | "OVER_AGGRESSIVE_CUT" | "MISSED_EDIT" | "CONTEXT_LOSS" | "PACING" | "COVERAGE_NEEDED";
