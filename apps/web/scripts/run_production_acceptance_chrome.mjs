...
const REAL_TRANSCRIPT = {
  ...
  segments: [
    ...
    },
    {
      ...
      start_ms: 68900,
      end_ms: 92100,
      text: "Deploy which is and how to deploy our application to Google Cloud and here is with test verified workflow and everything is working.",
      word_start_index: 74,
      word_end_index: 96,
    },
    {
      ...
      start_ms: 93900,
      end_ms: 96500,
      text: "You here you can find here the issues.",
      word_start_index: 97,
      word_end_index: 104,
    },
    {
      ...
      start_ms: 96500,
      end_ms: 101000,
      text: "You can write the workflow for issues.",
      word_start_index: 105,
      word_end_index: 111,
    },
  ],
...
const REAL_CORRECTED_SCRIPT = {
  ...
  segments: [
    ...
    },
    {
      ...
      source_end_ms: 92100,
      original_text:
        "Deploy which is and how to deploy our application to Google Cloud and here is with test verified workflow and everything is working.",
      corrected_text:
        "And how to deploy our application to Google Cloud with a test-verified workflow.",
      change_type: "GRAMMAR",
      reason:
        "Cleaned up run-on grammar, stumbles, and non-native sentence construction into clear spoken tutorial English.",
...
const REAL_EDL = {
  ...
  cuts: [
    ...
    {
      cut_id: "cut_e5cf9c237463",
      decision_id: "silence_cut_010",
      decision_type: "TRIM_PAUSE",
      transcript_start_word: 76,
      transcript_end_word: 77,
      requested_start_ms: 71000,
      requested_end_ms: 75300,
      safe_start_ms: 71525,
      safe_end_ms: 74975,
      removed_duration_ms: 3450,
      left_anchor: "is",
      right_anchor: "and",
      transition_ms: 20,
      safety_status: "SAFE",
    ...
    {
      cut_id: "cut_39793c045b2d",
      decision_id: "silence_cut_011",
      decision_type: "TRIM_PAUSE",
    ...
    {
      cut_id: "cut_d08a0b9684ad",
      decision_id: "silence_cut_012",
      decision_type: "TRIM_PAUSE",
    ...
    {
      cut_id: "cut_dd63b718328c",
      decision_id: "silence_cut_013",
      decision_type: "TRIM_PAUSE",
    ...
    {
      cut_id: "cut_ca2db9d2fcf8",
      decision_id: "silence_cut_014",
      decision_type: "TRIM_PAUSE",
    ...
    },
    {
      ...
      decision_type: "TRIM_PAUSE",
      transcript_start_word: 96,
      transcript_end_word: 97,
      requested_start_ms: 91600,
      requested_end_ms: 94000,
      safe_start_ms: 92225,
      safe_end_ms: 93775,
      removed_duration_ms: 1550,
      left_anchor: "working.",
      right_anchor: "You",
      transition_ms: 20,
      safety_status: "SAFE",
    ...
    },
    {
      ...
      decision_id: "dec_005_remove_repetition_issues",
      decision_type: "REMOVE_FALSE_START",
    ...
    {
      cut_id: "cut_55f5d5950182",
      decision_id: "silence_cut_016",
      decision_type: "TRIM_PAUSE",
...
const REAL_EDITORIAL_RUN = {
  ...
  summary:
    "Cleaned up stumbles, false starts, and aligned product terminology with GitHub Actions tutorial footage.",
  decisions: [
    {
      decision_id: "dec_01",
    ...
    },
    {
      ...
      action: "rephrase",
      concise_reason:
        "Polished grammar and non-native run-on construction into clean tutorial narration.",
      confidence: 0.97,
    },
  ],
...
async function main() {
    ...
    await route.fulfill({
      ...
      body: JSON.stringify({
        ...
        voice_settings: {
          ...
          my_voice_blocked_reason:
            "Google voice replication capability is currently BLOCKED pending project allowlist enablement.",
          updated_at: "2026-08-30T00:00:00Z",
        },
        voices: [
          {
          ...
          {
            voice_id: "Charon",
            display_name: "Charon (Authoritative, Deep)",
            gender: "male",
            language_code: "en-US",
          },
          {
            voice_id: "Kore",
            display_name: "Kore (Warm, Conversational)",
            gender: "female",
            language_code: "en-US",
          },
          {
            voice_id: "Fenrir",
            display_name: "Fenrir (Direct, Confident)",
            gender: "male",
            language_code: "en-US",
          },
          {
            voice_id: "Aoede",
            display_name: "Aoede (Articulate, Polished)",
            gender: "female",
            language_code: "en-US",
          },
        ],
  ...
  await page.goto(`${BASE_URL}/productions/${PRODUCTION_ID}/editor`, {
  ...
  const testSegments = [
    {
      id: "removed_region_cut_06",
      timeS: 24.7,
      label: "Removed Cut Region 6 (source pause 37.6s - 45.1s absent)",
    },
    {
      id: "seg_00_transcription",
      timeS: 3.5,
      label: "Corrected Segment 1 (GitHub Actions, edited 2.1s - 5.7s)",
    },
    {
      id: "seg_03_falsestart",
      timeS: 14.0,
      label: "Corrected Segment 2 (Cloudflare DNS, edited 11.1s - 17.55s)",
    },
    {
      id: "seg_08_grammar",
      timeS: 48.0,
      label: "Corrected Segment 3 (Google Cloud Deploy, edited 41.9s - 54.1s)",
    },
  ...
  const transcriptTab = page
    .getByTestId("tab-transcript")
    .or(page.getByRole("tab", { name: /Transcript/i }))
    .first();
