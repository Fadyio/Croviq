...
variable "certificate_root_dns_authorization_name" {
  type        = string
  description = "The DNS Resource Record Name for Google Certificate Manager root domain DNS authorization."
}

variable "certificate_root_dns_authorization_type" {
  type        = string
  description = "The DNS Resource Record Type for Google Certificate Manager root domain DNS authorization."
}

variable "certificate_root_dns_authorization_value" {
  type        = string
  description = "The DNS Resource Record Value (data) for Google Certificate Manager root domain DNS authorization."
}
